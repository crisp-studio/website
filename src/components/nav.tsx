...
export default ({ variant }) => (
  <Wrapper>
    ...
    <Menu >
      <MenuItemInternal to="/another-page/">Design Sprint</MenuItemInternal >
      <MenuItemInternal to="/another-page/">Dev Sprint</MenuItemInternal >
      <MenuItemInternal to="/studio/">Studio</MenuItemInternal >
      <MenuItemExternal href="https://medium.com/crispstudio">Blog</MenuItemExternal>
    </Menu>
  </Wrapper>
)
